package com.gmail.michzuerch.LehrerVerwaltung.backend.entity.report.jasper;
 ...
 */
@Entity
public class ReportJasper extends com.gmail.michzuerch.LehrerVerwaltung.backend.entity.AbstractEntity {
    @Column
    @NotNull
    @Size(min = 1, max = 50)
    ...
    private List<com.gmail.michzuerch.LehrerVerwaltung.backend.entity.report.jasper.ReportJasperImage> reportJasperImages = new ArrayList<>();
    ...
    public List<com.gmail.michzuerch.LehrerVerwaltung.backend.entity.report.jasper.ReportJasperImage> getReportJasperImages() {
        return reportJasperImages;
    }

    public void setReportJasperImages(List<com.gmail.michzuerch.LehrerVerwaltung.backend.entity.report.jasper.ReportJasperImage> reportJasperImages) {
