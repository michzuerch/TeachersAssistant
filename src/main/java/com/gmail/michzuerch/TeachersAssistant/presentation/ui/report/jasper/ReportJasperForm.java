...
import com.gmail.michzuerch.TeachersAssistant.presentation.ui.util.field.JasperXmlField;
...
public class ReportJasperForm extends AbstractForm<ReportJasper> {
    private static Logger logger = LoggerFactory.getLogger(com.gmail.michzuerch.TeachersAssistant.presentation.ui.report.jasper.ReportJasperForm.class.getName());
